                                                        ...
                                                        <div class="beau-article-content">
                                                            <h2 class="beau-article-title"><a
                                                                    href="{{route('app.post')}}/{{$post->getPostCategory->slug}}/{{$post->slug}}"><em
                                                                        class="text-limit"><i
                                                                            class="fal fa-arrow-alt-right"></i> {{$post->title}}
                                                                    </em></a></h2>
                                                            <div class="beau-article-author"><i
                                                                    class="fal fa-portrait"></i>
                                                            ...
                                                            <div class="beau-article-meta-wrapper">
                                                                ...
                                                                <span class="time-month"><i
                                                                        class="fal fa-calendar-alt"></i> {{$post->created_at}}</span>
                                                                </a>
                                                                |
                                                                <div class="beau-article-meta-tags">
                                                                <span><i class="fal fa-eye"></i> {{$post->view}}
                                                                    views</span> | <a
                                                                        href="#"><i
                                                                            class="far fa-clipboard-list-check"></i> {{$post->theme}}
                                                                    </a></div>
                                                            </div>
                                                        </div>
                                                    </article>
